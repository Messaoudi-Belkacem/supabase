...
const data: () => {
  ...
  return {
    ...
    platform: {
      ...
      className: cn(
        'sm:[&_div.grid>div:first-child]:border-l-0!',
        'sm:[&_div.grid>div]:-m-px',
        'sm:[&_div.grid>div:nth-child(2n+1)]:border-l!',
        'sm:[&_div.grid>div:nth-child(2n+2)]:border-t!',
        'lg:[&_div.grid>div:nth-child(3n+3)]:border-l-0!',
        'lg:[&_div.grid>div:nth-child(2)]:border-t-0!'
      ),
      features: [
        {
          id: 'database',
        ...
        },
        {
          ...
          image: (
            <div className="w-full p-4 lg:p-6 xl:p-8 h-full flex items-center justify-center">
              <div className="left-4 lg:left-6 xl:left-8 absolute w-full md:w-[600px] bg-surface-100 border border-overlay flex flex-col overflow-hidden rounded-sm shadow-2xs">
        ...
        },
        {
          ...
          image: (
            <div className="w-full p-4 lg:p-6 xl:p-8 h-full flex items-center justify-center">
              <div className="w-full bg-surface-100 border border-overlay flex flex-col overflow-hidden rounded-sm shadow-2xs">
                <div className="border-b border-overlay flex justify-between w-full py-3 px-5">
                  <div className="max-w-[85%] flex items-center space-x-3 truncate">
