...
const actionButtonVariants = cva(
  'pl-1.5 pr-3 py-1.5 rounded-sm shadow-sm flex justify-center items-center gap-2 outline-solid outline-1 -outline-offset-1 cursor-pointer flex-nowrap',
  {
    variants: {
      variant: {
        primary:
...
const iconVariants = cva(
  'w-5 h-5 px-2 rounded-xs outline-solid outline-1 -outline-offset-1 inline-flex flex-col justify-center items-center gap-2',
  {
    variants: {
      variant: {
