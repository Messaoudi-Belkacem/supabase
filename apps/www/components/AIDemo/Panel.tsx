        ...
        <div className="p-5 pt-0 relative z-10">
          <form onSubmit={handleSubmit} className={cn('rounded-md', styles['border-gradient'])}>
            <Input
              ...
              className={cn(
                'w-full bg-background-muted rounded-md [&>textarea]:border-1 [&>textarea]:rounded-md [&>textarea]:!outline-hidden [&>textarea]:!ring-offset-0 [&>textarea]:!ring-0 focus:outline-hidden'
              )}
            />
          </form>
        </div>
