              ...
              >
                {day1.steps.length > 0 && (
                  <div className="h-[400px] flex flex-col lg:flex-row group/day1 relative overflow-hidden">
                    ...
                    ></div>
                    <div
                      className={`flex flex-col flex-1 items-center gap-5 lg:items-start lg:justify-between border border-[#2E2E2E] rounded-xl h-full relative overflow-hidden after:absolute after:bg-no-repeat after:bg-position-[center_bottom] lg:after:bg-position-[right_15%_top_100px] xl:after:bg-position-[right_15%_top_60px] after:bg-size-[300px_180px] lg:after:bg-size-[450px_300px] xl:after:bg-size-[528px_367px] after:bg-[url('/images/launchweek/docs-update-bg.png')] after:top-0 after:right-0 after:bottom-0 after:left-0 p-14 text-2xl before:absolute before:w-full before:h-full before:top-52 before:right-0 before:bottom-0 before:left-0 before:border-[#1f3536] before:-z-10 px-3! sm:px-14!`}
                    >
