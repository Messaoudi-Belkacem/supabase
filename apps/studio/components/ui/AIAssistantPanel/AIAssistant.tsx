      ...
      <div className={cn('flex flex-col h-full w-full md:h-full max-h-[100dvh]', className)}>
        ...
        <div className="px-3 pb-3 z-20 relative">
          ...
          <AssistantChatForm
            ...
            className={cn(
              'z-20 [&>form>textarea]:text-base [&>form>textarea]:md:text-sm [&>form>textarea]:border-1 [&>form>textarea]:rounded-md [&>form>textarea]:!outline-hidden [&>form>textarea]:!ring-offset-0 [&>form>textarea]:!ring-0'
            )}
